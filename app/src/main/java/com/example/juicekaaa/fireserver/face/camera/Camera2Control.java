package com.example.juicekaaa.fireserver.face.camera;/*
            ...
            new TextureView.SurfaceTextureListener() {
                ...
                public void onSurfaceTextureUpdated(SurfaceTexture texture) {
                    ...
                    if (onFrameListener != null && bitmap != null) {
                        onFrameListener.onPreviewFrame(bitmap, 0, bitmap.getWidth(), bitmap.getHeight());
                    }
                }
            };
...
//        byte[] argb = new byte[image.getWidth() *image.getHeight() * 4 ];
//        out.copyTo(argb);

        Log.e("wtf", "YUV_420_888_toRGBIntrinsics->" + (System.currentTimeMillis() - starttime));
        return data ;
    }
