...
public class FunctionHomeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setVideo() {
        videos = findViewById(R.id.videos);
        MediaController mediaController = new MediaController(FunctionHomeActivity.this);
        ...
        videos.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                shimmer.cancel();
                Intent i = new Intent(FunctionHomeActivity.this, MainActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.funtion_material:
                shimmer.cancel();
                Intent funtion_material = new Intent(FunctionHomeActivity.this, FunctionOperationActivity.class);
                startActivity(funtion_material);
                break;
            //开门
            case R.id.funtion_opendoor:
                shimmer.cancel();
                Intent funtion_opendoor = new Intent(FunctionHomeActivity.this, FunctionOperationActivity.class);
                startActivity(funtion_opendoor);
                break;
            //SOS
            case R.id.funtion_sos:
                SosDialog sosDialog = new SosDialog(FunctionHomeActivity.this);
                sosDialog.show();
                break;
            //宣传
            ...
            case R.id.online_help:
                shimmer.cancel();
                Intent funtion_help = new Intent(FunctionHomeActivity.this, FunctionHelpActivity.class);
