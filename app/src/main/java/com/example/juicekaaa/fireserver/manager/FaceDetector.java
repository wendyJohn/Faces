...
//        Log.e("gangzi", "mFaceDetect.trackMaxFace --- before--" + height + "  w: " + width);

//        if (FaceEnvironment.isFeatureDetect) {
//            return null;
//        }
        // FaceEnvironment.isFeatureDetect = true;
        FaceInfo[] faceInfos = mFaceDetect.trackMaxFace(argb, height, width);
        // FaceEnvironment.isFeatureDetect = false;
//        Log.e("gangzi", "mFaceDetect.trackMaxFace --- after" + height + "  w: " + width);
        return faceInfos;
    }
